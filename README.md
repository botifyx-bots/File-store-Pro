...
<p align="center">
  <a href="https://github.com/botifyx-bots/File-store-Pro/stargazers">
    <img src="https://img.shields.io/github/stars/botifyx-bots/File-store-Pro?color=black&logo=github&logoColor=white&style=for-the-badge" alt="Stars"/>
  </a>
  <a href="https://github.com/botifyx-bots/File-store-Pro/network/members">
    <img src="https://img.shields.io/github/forks/botifyx-bots/File-store-Pro?color=black&logo=github&logoColor=white&style=for-the-badge"/>
  </a>
  <a href="https://github.com/botifyx-bots/File-store-Pro/blob/main/LICENSE">
  ...
  <a href="https://github.com/botifyx-bots/File-store-Pro/commits/main">
    <img src="https://img.shields.io/github/last-commit/botifyx-bots/File-store-Pro?color=blue&logo=github&logoColor=green&style=for-the-badge"/>
  </a>
</p>

<p align="center">
  <a href="https://telegram.me/BotifyX_Pro_Botz">
...
| Command | Description |
|---|---|
| `/start` | Check alive or dead! |
| `/buy` | See premium plans or buy |
| `/credits` | Check your credit status |
| `/profile` | View your profile |

### 👑 ᴏᴡɴᴇʀ / ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅs

| Command | Description |
|---|---|
| `/shortner` | Open shortener configs |
| `/genlink` | Generate a link for one file |
| `/batch` | Generate links for more than one file |
| `/usage` | Check link usage stats |
| `/stats` | See full bot stats |
| `/users` | View all users list |
| `/broadcast` | Send a message to all users |
| `/pbroadcast` | Send a message to premium users only |
| `/ban` | Ban a user |
| `/unban` | Unban a user |
...
| Command | Description |
|---|---|
| `/addpremium` | Add any user to premium |
| `/delpremium` | Remove any user from premium |
| `/premiumusers` | Get list of all premium users |
| `/add_credit` | Add credits to any user |

### 🗄️ ᴅᴀᴛᴀʙᴀsᴇ ᴄʜᴀɴɴᴇʟ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ

| Command | Description |
|---|---|
| `/db` | View DB channel configs |
| `/adddb` | Add a primary or secondary DB channel |
| `/removedb` | Remove a DB channel |
...
> ⚠️ **Edit `config.py` with your values before deploying on any platform.**
...
> Render injects `PORT=10000` automatically. Flask health check hits `"/"` and keeps your service alive.

---

### 🟣 ᴅᴇᴩʟᴏʏ ᴏɴ ʜᴇʀᴏᴋᴜ

#### Option A — Heroku Container Stack (recommended)
...
<p>
<a href="https://dashboard.heroku.com/new?template=https://github.com/botifyx-bots/File-store-Pro">
...
### 🖥️ ᴅᴇᴩʟᴏʏ ᴏɴ ᴠᴘs / ʟᴏᴄᴀʟ

#### Method A — Plain Python
...
- 🔑 Token-based verification on every file link
...
You are free to use, modify, and share it — but you must give credit and keep it under the GPL license.
...
<h3 align="center">
  🤝 Contributions are always welcome!<br/>Feel free to open pull requests to improve this repo 🖤
</h3>

<p align="center">
  <a href="https://telegram.me/BotifyX_Pro_Botz">
    <img src="https://img.shields.io/badge/Support%20%40BotifyX__Pro__Botz-blue.svg?style=for-the-badge&logo=Telegram"/>
  </a>
</p>
